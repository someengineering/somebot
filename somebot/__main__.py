...
SLACK_FORWARD_USER = os.getenv("SLACK_FORWARD_USER")
...
if (
    ...
    or not SLACK_FORWARD_USER
    or not DISCORD_FORWARD_CHANNEL_ID
):
    log.fatal(
        "DISCORD_TOKEN, SLACK_BOT_TOKEN, SLACK_APP_TOKEN, SLACK_SIGNING_KEY, SLACK_FORWARD_USER and DISCORD_FORWARD_CHANNEL_ID must be set"
    )
    sys.exit(1)
